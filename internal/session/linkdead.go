...
func renderRoomForReconnect(a *connActor, cfg Config) string {
	...
	view := command.RenderRoom(r, cfg.Placement, cfg.Items, questMarkerFor(cfg.Quests, a.PlayerID()), cfg.Ambience, nil, lvl, exitVisibleFor(a, cfg.AdminRole), command.QuestSpawnVisible(a, cfg.AdminRole), otherPlayerNames(cfg.Manager, r.ID, a.PlayerID())...)
