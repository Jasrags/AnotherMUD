...
func TestRenderRoom_BlackSuppressesEverything(t *testing.T) {
	...
	out := command.RenderRoom(f.room, f.place, f.store, nil, nil, nil, light.Black)
...
func TestRenderRoom_GloomObscures(t *testing.T) {
	...
	out := command.RenderRoom(f.room, f.place, f.store, nil, nil, nil, light.Gloom, "Bob")
...
func TestRenderRoom_GloomEmptyRoomNoExits(t *testing.T) {
	...
	out := command.RenderRoom(f.room, f.place, f.store, nil, nil, nil, light.Gloom)
...
func TestRenderRoom_DimIsFullButMuted(t *testing.T) {
	f := newRenderFixture()
	full := command.RenderRoom(f.room, f.place, f.store, nil, nil, nil, light.Lit)
	dim := command.RenderRoom(f.room, f.place, f.store, nil, nil, nil, light.Dim)
