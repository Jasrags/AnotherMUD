...
func RegisterBuiltins(r *Registry) error {
	commands := []Command{
		...
		{Keyword: "firemode", Handler: FireModeHandler, Brief: "Set a weapon's firing mode (single/burst/auto).", Syntax: []string{"firemode", "firemode single|burst|auto"}},
		...
		{Keyword: "improve", Handler: ImproveHandler, Brief: "Spend karma to raise a skill, attribute, or quality.", Syntax: []string{"improve", "improve <target> [param]"}},
