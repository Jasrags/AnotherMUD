...
func decodeAbility(path, ns string) (*progression.Ability, error) {
	...
	return &progression.Ability{
		...
		LinkedAttribute:       progression.StatType(strings.TrimSpace(f.LinkedAttribute)),
		SkillGroup:            strings.TrimSpace(f.SkillGroup),
		SkillCategory:         strings.TrimSpace(f.SkillCategory),
		TrainedOnly:           f.TrainedOnly,
		DefaultPenalty:        f.DefaultPenalty,
		Cost:                  f.Cost,
