...
make worlddoc   # render world docs for every pack to docs/world/ (map + index)
...
| Doc | What it is |
|---|---|
| [`docs/specs/`](docs/specs/) | **Behavior specifications — the source of truth** (64 specs; read `docs/specs/README.md` first) |
