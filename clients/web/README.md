...
- **Enriched packages, so far.** Six rich additive packages are surfaced beyond
  ...
  journal, P3 Slice C), and `Char.Trade` (the direct-trade form, P3 Slice B++).
  Still on the wire but
